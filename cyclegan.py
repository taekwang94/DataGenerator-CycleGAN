...
class CycleGAN():
    def __init__(self):
        ...
        self.data_loader = DataLoader(dataset_path=self.args.dataset_path ,dataset_name=self.dataset_name,
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % 5 == 0:
                ...
                self.d_B.save(os.path.join(self.args.save_path, 'd_B_{}.h5'.format(epoch)))
    ...
    #     directory = os.path.join('/home/taekwang0094/WorkSpace/Keras-GAN/cyclegan/saved_models', self.date_time)
    #     if not os.path.exists(directory):
    #         os.makedirs(directory)
    #
    #     model_path_w = '/home/taekwang0094/WorkSpace/Keras-GAN/cyclegan/saved_models/{}/{}_weights_epoch_{}.hdf5'.format(
    #         self.date_time, model.name, epoch)
    #     model.save_weights(model_path_w)
    #     model_path_m = '/home/taekwang0094/WorkSpace/Keras-GAN/cyclegan/saved_models/{}/{}_model_epoch_{}.json'.format(
    #         self.date_time, model.name, epoch)
